---
name: skillint
description: Audit Codex, Cursor, Claude Code, Grok, Gemini, Copilot, and other agent skills. Use when the user wants to lint skills, find duplicate SKILL.md files, estimate context tokens, or slim down AGENTS.md and rules. skillint is eslint for the skills folder.
---
